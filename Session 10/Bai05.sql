drop database if exists ss10_ex5;
create database ss10_ex5;
use ss10_ex5;
...
select u.user_id, u.username, u.full_name, u.hometown, fr.user_id as friend_user_id, fr.username as friend_username, fr.full_name as friend_full_name, f.status, f.created_at as friend_created_at
from users u
join friends f on f.user_id = u.user_id
join users fr on fr.user_id = f.friend_id
